...
// V3: Minimal approach - no useState, direct DOM manipulation in single useEffect
export function NotationViewV3({ tune, transpose, progress, isPlaying, highlightOffset = 0 }: NotationViewProps) {
